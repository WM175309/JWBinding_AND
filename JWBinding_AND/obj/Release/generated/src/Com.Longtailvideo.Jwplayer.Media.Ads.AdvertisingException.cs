...
namespace Com.Longtailvideo.Jwplayer.Media.Ads {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.longtailvideo.jwplayer.media.ads']/class[@name='AdvertisingException']"
	[global::Android.Runtime.Register ("com/longtailvideo/jwplayer/media/ads/AdvertisingException", DoNotGenerateAcw=true)]
	public partial class AdvertisingException : global::Java.Lang.RuntimeException {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/longtailvideo/jwplayer/media/ads/AdvertisingException", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (AdvertisingException); }
		}

		protected AdvertisingException (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_Throwable_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.longtailvideo.jwplayer.media.ads']/class[@name='AdvertisingException']/constructor[@name='AdvertisingException' and count(parameter)=1 and parameter[1][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/Throwable;)V", "")]
		public unsafe AdvertisingException (global::Java.Lang.Throwable p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AdvertisingException)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.longtailvideo.jwplayer.media.ads']/class[@name='AdvertisingException']/constructor[@name='AdvertisingException' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Throwable']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Throwable;)V", "")]
		public unsafe AdvertisingException (string p0, global::Java.Lang.Throwable p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.longtailvideo.jwplayer.media.ads']/class[@name='AdvertisingException']/constructor[@name='AdvertisingException' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe AdvertisingException (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.longtailvideo.jwplayer.media.ads']/class[@name='AdvertisingException']/constructor[@name='AdvertisingException' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AdvertisingException ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Throwable) this).Handle != IntPtr.Zero)
				return;
