...
namespace Com.Google.Android.Exoplayer.Extractor.Wav {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']"
	[global::Android.Runtime.Register ("com/google/android/exoplayer/extractor/wav/WavExtractor", DoNotGenerateAcw=true)]
	public sealed partial class WavExtractor : global::Java.Lang.Object, global::Com.Google.Android.Exoplayer.Extractor.ISeekMap {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/google/android/exoplayer/extractor/wav/WavExtractor", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WavExtractor); }
		}

		internal WavExtractor (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/constructor[@name='WavExtractor' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WavExtractor ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (WavExtractor)) {
					SetHandle (
		...
		public unsafe bool IsSeekable {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='isSeekable' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='getPosition' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='read' and count(parameter)=2 and parameter[1][@type='com.google.android.exoplayer.extractor.ExtractorInput'] and parameter[2][@type='com.google.android.exoplayer.extractor.PositionHolder']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='release' and count(parameter)=0]"
		[Register ("release", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='seek' and count(parameter)=0]"
		[Register ("seek", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.android.exoplayer.extractor.wav']/class[@name='WavExtractor']/method[@name='sniff' and count(parameter)=1 and parameter[1][@type='com.google.android.exoplayer.extractor.ExtractorInput']]"
