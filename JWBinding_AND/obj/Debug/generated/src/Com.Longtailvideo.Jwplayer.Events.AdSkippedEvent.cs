...
namespace Com.Longtailvideo.Jwplayer.Events {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.longtailvideo.jwplayer.events']/class[@name='AdSkippedEvent']"
	[global::Android.Runtime.Register ("com/longtailvideo/jwplayer/events/AdSkippedEvent", DoNotGenerateAcw=true)]
	public partial class AdSkippedEvent : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/longtailvideo/jwplayer/events/AdSkippedEvent", ref java_class_handle);
			}
		}
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (AdSkippedEvent)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Longtailvideo.Jwplayer.Events.AdSkippedEvent __this = global::Java.Lang.Object.GetObject<global::Com.Longtailvideo.Jwplayer.Events.AdSkippedEvent> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Longtailvideo.Jwplayer.Media.Ads.AdSource Client {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.longtailvideo.jwplayer.events']/class[@name='AdSkippedEvent']/method[@name='getClient' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string CreativeType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.longtailvideo.jwplayer.events']/class[@name='AdSkippedEvent']/method[@name='getCreativeType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Tag {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.longtailvideo.jwplayer.events']/class[@name='AdSkippedEvent']/method[@name='getTag' and count(parameter)=0]"
